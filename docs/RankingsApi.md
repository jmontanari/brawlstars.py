...
Get brawler rankings for a country or global rankings. Brawler identifiers can be found by using the /v1/brawlers API
endpoint.
...
api_instance = brawlstars.RankingsApi(brawlstars.ApiClient(configuration))
