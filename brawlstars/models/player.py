...
class Player(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.brawlers:
            for _item_brawlers in self.brawlers:
                if _item_brawlers:
                    _items.append(_item_brawlers.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "club": PlayerClub.from_dict(obj["club"]) if obj.get("club") is not None else None,
            "isQualifiedFromChampionshipChallenge": obj.get("isQualifiedFromChampionshipChallenge"),
            "3vs3Victories": obj.get("3vs3Victories"),
            ...
            "highestTrophies": obj.get("highestTrophies"),
            "soloVictories": obj.get("soloVictories"),
