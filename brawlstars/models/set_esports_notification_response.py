...
class SetEsportsNotificationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["notification", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notification": SetEsportsNotificationRequest.from_dict(obj["notification"]) if obj.get("notification") is not None else None,
