...
class CompletedGame(BaseModel):
    ...
    CompletedGame
    """ # noqa: E501
    teams: Optional[List[CompletedGameTeam]] = None
    duration: Optional[StrictInt] = None
    location: Optional[MatchLocation] = None
    replay_id: Optional[StrictStr] = Field(default=None, alias="replayId")
    __properties: ClassVar[List[str]] = ["teams", "duration", "location", "replayId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "teams": [CompletedGameTeam.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None,
            "duration": obj.get("duration"),
            "location": MatchLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
