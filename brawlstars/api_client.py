...
import brawlstars.models
from brawlstars import rest
from brawlstars.api_response import ApiResponse, T as ApiResponseT
from brawlstars.configuration import Configuration
from brawlstars.exceptions import (
    ApiValueError,
    ApiException
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(brawlstars.models, klass)
