...
class ClubMember(object):
    ...
    def __init__(self, icon=None, tag=None, name=None, trophies=None, role=None, name_color=None, _configuration=None):  # noqa: E501
    ...
    @property
    def icon(self):
        """Gets the icon of this ClubMember.  # noqa: E501


        :return: The icon of this ClubMember.  # noqa: E501
        :rtype: PlayerIcon
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this ClubMember.


        :param icon: The icon of this ClubMember.  # noqa: E501
        :type: PlayerIcon
        """
    ...
    def role(self, role):
        ...
        :type: str
        """
        allowed_values = ["notMember", "member", "president", "senior", "vicePresident", "unknown"]  # noqa: E501
