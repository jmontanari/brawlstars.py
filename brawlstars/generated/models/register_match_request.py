...
class RegisterMatchRequest(object):
    ...
    def __init__(self, mode=None, players=None, location_id=None, wins_required=None, gadgets_allowed=None, banned_brawlers=None, timer_preset=None, _configuration=None):  # noqa: E501
    ...
    def timer_preset(self, timer_preset):
        ...
        if (self._configuration.client_side_validation and
                timer_preset not in allowed_values):
            raise ValueError(
