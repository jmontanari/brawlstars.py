...
class PlayerRanking(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["club", "icon", "trophies", "tag", "name", "rank", "nameColor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "club": PlayerRankingClub.from_dict(obj["club"]) if obj.get("club") is not None else None,
