...
class PlayerRanking(object):
    ...
    def __init__(self, club=None, icon=None, trophies=None, tag=None, name=None, rank=None, name_color=None, _configuration=None):  # noqa: E501
    ...
    @property
    def icon(self):
        """Gets the icon of this PlayerRanking.  # noqa: E501


        :return: The icon of this PlayerRanking.  # noqa: E501
        :rtype: PlayerIcon
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this PlayerRanking.


        :param icon: The icon of this PlayerRanking.  # noqa: E501
        :type: PlayerIcon
        """
